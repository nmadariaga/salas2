              ...
              <div class="col-lg-12">
                  <div class="form-panel">
                    ...
                    <div class="alert alert-danger">
                      ...
                      @endif
                      <h4 class="mb">Edite la información del Departamento "{{$departamento->nombre}}" </h4>
                      ...
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Campus: </label>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{!! Form::select('facultad_id', $facultad) !!}
							  </div>
...
<br>
<table>
              <td><a href="/departamentos" class="btn btn-default btn-sm">Volver</a></td>
</table>
</center>
    </section>
      </section>
